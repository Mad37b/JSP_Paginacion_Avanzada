...
<!--  Me conecto a la base de datos -->
    ...
    //
			...
			if (productos !=null){
				out.print("productos No es null");
			}else{
				out.print("producto es Null");
			}
	...
	<table class="tabla" border="1">
		...
		<%
		if( productos !=null){
			Mensajes.verMensaje("prueba producto" + productos);
		%>
	...
	<%}else{out.print("Producto ha sido null : "+productos.toString());} %>
	<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< FORM >>>>>>>>>>>>>>>>>>>>>>>> -->
	<!-- FORM  -->
	<!-- Select -->
